    ...
    <div class="modal-dialog" style="width: 600px;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <div style="width: 100%; display:flex;">
                            <div style="width:90%; display:flex;">
                                ...
                                <input type="text" name="des_acu_ci" class="form-control input-sm" readOnly/>
                            </div>
                            <div style="width:10%;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="precio_unitario_ci" onChange="calculaPrecioTotalCI();" class="form-control right" readOnly/>
                    </div>
                    <div class="col-md-4">
                        <h5>Unid. Medida</h5>
                        <select class="form-control" style="font-size:12px;" 
                            name="unid_medida_ci" disabled="true">
            ...
            <div class="modal-footer">
                <button class="btn btn-sm btn-success" onClick="guardar_partida_ci();">Guardar</button>
            </div>
        </div>
    </div>  
</div>
