                ...
                <table class="tabla-totales" width="100%">
                    <tbody>
                        <tr>
                            ...
                            <td><input type="number" class="importe blue" name="total_costo_directo_pi" disabled="true" value="0"/></td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="number" class="importe blue" name="total_ci_pi" disabled="true" value="0"/></td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="number" class="importe blue" name="total_gg_pi" disabled="true" value="0"/></td>
                        </tr>
                    </tbody>
                    <tfoot>
                        <tr>
                            ...
                            <td><input type="number" class="importe blue" name="sub_total_pi" disabled="true" value="0"/></td>
                        </tr>
                    </tfoot>
                </table>
            </div>
                ...
                <table class="tabla-totales" width="100%">
                    <tbody>
                        <tr>
                            ...
                            <td><input type="number" class="importe blue" name="subtotal_pi" disabled="true" value="0"/></td>
                        </tr>
                        <tr>
                            <td>Utilidad</td>
                            <td>
                            ...
                            <td><input type="number" class="importe blue" name="total_utilidad_pi" disabled="true" value="0"/></td>
                        </tr>
                        <tr>
                            <td>IGV</td>
                            <td>
                            ...
                            <td><input type="number" class="importe blue" name="total_igv_pi" disabled="true" value="0"/></td>
                        </tr>
                    </tbody>
                    <tfoot>
                        <tr>
                            ...
                            <td><input type="number" class="importe blue" name="total_presupuestado_pi" disabled="true" value="0"/></td>
                        </tr>
                    </tfoot>
                </table>
            </div>
