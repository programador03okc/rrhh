    ...
    <legend class="mylegend">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                ...
                onClick="abrir_presint();">Ver Presupuesto </button>
            </li>
        </ol>
    </legend>
                ...
                <table class="tabla-totales" width="100%">
                    <tbody>
                        <tr>
                            ...
                            <td width="20%"></td>
                            <td><input type="number" name="subtotal" disabled="true" value="0"/></td>
                        </tr>
                        <tr>
                            <td>Utilidad</td>
                            <td>
                            ...
                            <td><input type="number" name="total_utilidad" disabled="true" value="0"/></td>
                        </tr>
                        <tr>
                            <td>IGV</td>
                            <td>
                            ...
                            <td><input type="number" name="total_igv" disabled="true" value="0"/></td>
                        </tr>
                    </tbody>
                    <tfoot>
                        <tr>
