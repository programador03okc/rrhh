...
<div class="page-main" type="sis_contrato">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <form id="form-sis_contrato" type="register" form="formulario">
                <input type="hidden" name="_token" value="{{csrf_token()}}" id="token">
                <div class="row">
                    <div class="col-md-6">
                        <h5>Codigo</h5>
                        <input type="hidden" name="id_sis_contrato" primary="ids">
...
<script src="{{('/js/proyectos/sis_contrato.js')}}"></script>
