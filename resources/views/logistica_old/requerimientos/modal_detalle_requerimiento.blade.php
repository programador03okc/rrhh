                ...
                <form id="form-detalle-requerimiento" type="register" form="formulario">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div style="display:flex;">
                                ...
                                <input type="text" name="codigo_item" class="form-control input-sm group-elemento" style="width:200px;text-align:center;" readonly="">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <select name="unidad_medida_item" class="form-control input-sm activation" required>
                        ...
                        <div class="col-md-2">
                            <h5>Cantidad</h5>
                            <input type="text" class="form-control input-sm activation" name="cantidad_item" step="any" required>
                        </div>
                        <div class="col-md-2">
                            <h5>Precio Ref.</h5>
                            <input type="text" class="form-control input-sm activation" name="precio_ref_item" step="any" required>
                        </div>
        
                        <div class="col-md-2">
                            <h5>Fecha Entrega</h5>
                            <input type="date" class="form-control input-sm activation" name="fecha_entrega_item" step="any" required>
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div style="display:flex;">
                                ...
                                <input type="text" name="cod_partida" class="form-control input-sm group-elemento" style="width:200px;text-align:center;" readonly="">
                                <div class="input-group-okc">
                                <input type="text" class="form-control input-sm" name="des_partida" placeholder="" aria-describedby="basic-addon8" required>
                                <div class="input-group-append">
