...
<div class="page-main" type="tipo">
    <legend><h2>Tipo de Producto</h2></legend>
    <div class="row">
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            <form id="form-tipo" type="register" form="formulario">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <h5>Codigo</h5>
                        <input type="text" class="form-control" readonly name="id_tipo_producto" primary="ids">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
...
<script src="{{('/js/almacen/tipo_producto.js')}}"></script>
