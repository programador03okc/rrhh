...
// Route::get('menu', 'LoginController@view_menu');
...
//NEW EDGAR
Route::get('botones', 'ConfiguracionController@view_botones');
Route::get('listar_botones', 'ConfiguracionController@mostrar_botones_table');
Route::get('cargar_botones/{id}', 'ConfiguracionController@mostrar_botones_id');
Route::post('guardar_botones', 'ConfiguracionController@guardar_botones');
Route::post('editar_botones', 'ConfiguracionController@actualizar_botones');
Route::get('anular_botones/{id}', 'ConfiguracionController@anular_botones');
...
Route::get('generar_planilla', 'RecursosHumanosController@generar_planilla_pdf');
Route::get('generar_planilla_pdf/{plani}/{mes}', 'RecursosHumanosController@generar_planilla_pdf');
Route::get('reporte_planilla_xls/{plani}/{mes}', 'RecursosHumanosController@reporte_planilla_xls');
...
Route::get('cargar_data_remun/{plani}/{mes}/{anio}', 'RecursosHumanosController@cargar_remuneraciones');
...
Route::get('anular_reintegro/{id}', 'RecursosHumanosController@anular_reintegro');
 ...
 // SOLO PRUEBAS
Route::get('tardanza_trabajador/{ini}/{fin}/{emp}/{sede}', 'RecursosHumanosController@tardanza_trabajador');
Route::get('verifyDataHorario/{fecha}/{tipo}/{emp}/{sede}', 'RecursosHumanosController@verifyDataHorario');
...
Route::get('listar_guias_compra', 'AlmacenController@mostrar_guias_compra');
...
Route::get('listar_guia_detalle/{guia}', 'AlmacenController@mostrar_guia_detalles');
...
Route::get('validar/{id}', 'AlmacenController@validar');

Route::get('ocs/{id}', 'AlmacenController@ocs');
Route::get('ver_detalle/{id}', 'AlmacenController@ver_detalle');
...
Route::post('guardar_proveedor', 'EquipoController@guardar_proveedor');
...
Route::post('guardar_asignacion', 'EquipoController@guardar_equi_asig');
...
Route::group(['middleware' => ['auth', 'roles:1,2,3,7'], 'prefix' => 'tesoreria', 'as' => 'tesoreria.'], function () {

    //Route::get('login', 'Tesoreria\LoginController@showLoginForm')->name('login');
    Route::get('', 'TesoreriaController@index')->name('index');

    Route::group(['prefix' => 'planillapagos', 'as' => 'planillapagos.'], function () {
    ...
    Route::resources([
        'cajachica' => 'Tesoreria\CajaChicaController',
        'cajachica_movimientos' => 'Tesoreria\CajaChicaMovimientosController',
        'solicitud' => 'Tesoreria\SolicitudController',
        'planillapagos' => 'Tesoreria\PlanillaPagosController',
        'tcambio' => 'Tesoreria\TipoCambioController',
        ]);
...
// Route::get('logistica/mostrar-archivos-adjuntos/{id}', 'LogisticaController@mostrar_archivos_adjuntos');
...
// Route::get('cargar_estructura_org/{id}', 'LogisticaController@cargar_estructura_org');
...
// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// /* Edgar */
// Route::get('logistica/listar_requerimientos', 'LogisticaController@listar_requerimiento');
...
// Route::get('/logistica/mostrar_orden_por_cotizacion/{id}', 'LogisticaController@mostrar_orden_por_cotizacion');
...
Route::get('logistica/mostrar_items', 'LogisticaController@mostrar_items');
Route::get('logistica/mostrar_item/{id_item}', 'LogisticaController@mostrar_item');
// Route::get('cargar_estructura_org/{id}', 'LogisticaController@cargar_estructura_org'); /////// modal area
Route::get('logistica/proyectos_contratos', 'ProyectosController@mostrar_proyectos_contratos');
Route::get('logistica/proyecto/{id}', 'ProyectosController@mostrar_proyecto');
Route::get('logistica/requerimientos', 'LogisticaController@mostrar_requerimientos');
...
Route::get('consult_aprob/{id}', 'LogisticaController@consult_aprob');
Route::get('pruebax/{id}', 'LogisticaController@mostrar_requerimiento_id');
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/* Edgar */
Route::get('logistica/listar_requerimientos', 'LogisticaController@listar_requerimiento');
...
Route::put('logistica/cuadro_comparativos/update_valorizacion/{id}', 'LogisticaController@update_valorizacion');
...
Route::get('logistica/cuadro_comparativo/grupo_cotizaciones/{codigo_cotizacion}/{codigo_cuadro_comparativo}', 'LogisticaController@grupo_cotizaciones')->where('id', '(.*)');  
